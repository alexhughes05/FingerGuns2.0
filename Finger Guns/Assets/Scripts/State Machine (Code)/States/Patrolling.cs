...
public class Patrolling : MonoBehaviour
{
    ...
    //Private Fields
    private StateMachineWithCode stateMachine;

    //Properties
    public bool TargetInAggroRange { get; set; }
    private void Awake()
    {
        stateMachine = new StateMachineWithCode();
        ...
        #region Transitions
        //Set Transitions
        stateMachine.AddTransition(patrolState, attackState, () => TargetInAggroRange);  //PATROL --> ATTACK
        stateMachine.AddTransition(attackState, patrolState, () => !TargetInAggroRange); //ATTACK --> PATROL
        #endregion
